...
{
    class KlimatogramZuidDummy : Klimatogram
    {
        ...
        public KlimatogramZuidDummy() : base(temperatuurWaarden.ToList(), neerslagWaarden.ToList(), 0, 0, 1961, 1990)
        {
        }
        ...
        public override double Breedtegraad { get { return -1.0; } }

        public override double Lengtegraad { get { return -20.0; } }
